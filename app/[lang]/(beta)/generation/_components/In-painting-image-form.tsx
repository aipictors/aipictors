...
import { createBase64FromImageURL } from "@/app/[lang]/(beta)/generation/_utils/create-base64-from-image-url"
import { createRandomString } from "@/app/[lang]/(beta)/generation/_utils/create-random-string"
      ...
      await createTask({
        variables: {
          input: {
            ...
            vae: props.configVae,
            type: "INPAINTING",
            t2tImageUrl: maskImageURL,
            t2tMaskImageUrl: srcImageURL,
