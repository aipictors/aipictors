...
export function GlowingGradientBorderButton(props: Props) {
  return (
    <button
      ...
      className={` bg-monotone-100 m-4 relative ${props.className}`}
    >
      <div className="mx-auto max-w-7xl">
        <div className="group relative cursor-pointer">
          ...
          <div className="items-top relative flex justify-center space-x-6 rounded-lg bg-background px-4 py-4 leading-none ring-1 ring-gray-900/5">
            {props.children}
          </div>
        </div>
      </div>
