    ...
    >
      <div className="mx-auto max-w-7xl">
        <div className="group relative cursor-pointer">
          <div className="-inset-1 absolute rounded-lg bg-gradient-to-r from-red-600 to-violet-600 opacity-25 blur transition duration-1000 dark:opacity-75 group-hover:opacity-90 group-hover:duration-200" />
