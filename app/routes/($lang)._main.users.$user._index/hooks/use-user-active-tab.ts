...
export const useUserActiveTab = (props: Props) => {
  return () => {
    if (props.url.endsWith("/posts"))
      return props.lang === "ja" ? "画像" : "Images"
    if (props.url.endsWith("/novels"))
      return props.lang === "ja" ? "小説" : "Novels"
    if (props.url.endsWith("/notes"))
      return props.lang === "ja" ? "コラム" : "Columns"
    if (props.url.endsWith("/videos"))
