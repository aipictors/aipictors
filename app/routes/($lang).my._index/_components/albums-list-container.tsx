...
import { AlbumsList } from "@/routes/($lang).my._index/_components/albums-list"
import { WorksSeriesAddButton } from "@/routes/($lang).my._index/_components/works-series-add-button"
