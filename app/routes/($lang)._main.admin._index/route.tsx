...
const quickActions = [
  ...
  {
    href: "/admin/amazon-exchange",
    title: "Amazonギフト券交換申請",
    subtitle: "交換申請にコードを入力して承認",
  },
  {
...
export default function AdminDashboardPage() {
  ...
  const reportCount = moderationItems.filter(
    (item: any) => item.kind === "REPORT",
  ).length
  const appealCount = moderationItems.filter(
    (item: any) => item.kind === "APPEAL",
  ).length
