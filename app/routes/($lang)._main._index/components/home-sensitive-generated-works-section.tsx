...
type Props = {
  works: FragmentOf<typeof HomeSensitiveGeneratedWorkFragment>[]
...
export const HomeSensitiveGeneratedWorkFragment = graphql(
  `fragment HomeSensitiveGeneratedWork on WorkNode @_unmask {
    id
    ...HomeWork
  }`,
  [HomeWorkFragment],
...
const WorksQuery = graphql(
  `query SensitiveGeneratedWorks($offset: Int!, $limit: Int!, $where: WorksWhereInput) {
