...
import { FallbackTaskCard } from "~/routes/($lang).generation.demonstration/components/fallback-task-card"
import {
  GenerationResultCardFragment,
  GenerationResultCardTaskFragment,
  GenerationTaskCard,
} from "~/routes/($lang).generation.demonstration/components/generation-task-card"
