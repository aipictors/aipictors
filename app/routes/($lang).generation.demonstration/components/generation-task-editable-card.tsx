...
import { useGenerationQuery } from "~/routes/($lang).generation.demonstration/hooks/use-generation-query"
...
import { ReservedGenerationCard } from "~/routes/($lang).generation.demonstration/components/reserved-generation-card"
import { InProgressGenerationCard } from "~/routes/($lang).generation.demonstration/components/in-progress-generation-card"
import { GenerationTaskZoomUpButton } from "~/routes/($lang).generation.demonstration/components/generation-task-zoom-up-button"
import { GenerationTaskRatingButton } from "~/routes/($lang).generation.demonstration/components/generation-task-rating-button"
import { GenerationTaskDeleteButton } from "~/routes/($lang).generation.demonstration/components/generation-task-delete-button"
import {
  GenerationResultProtectButtonFragment,
  GenerationResultProtectButtonTaskFragment,
} from "~/routes/($lang).generation.demonstration/components/generation-task-protected-button"
