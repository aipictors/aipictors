...
import { GenerationReferenceDialog } from "~/routes/($lang).generation.demonstration/components/generation-reference-dialog-button"
import { GenerationTaskContentImagePlaceHolder } from "~/routes/($lang).generation.demonstration/components/generation-task-content-image-place-holder"
import type { GenerationParameters } from "~/routes/($lang).generation.demonstration/types/generation-parameters"
import type { GenerationSize } from "~/routes/($lang).generation.demonstration/types/generation-size"
import {
  ArrowDownToLine,
  ArrowUpRightSquare,
  ChevronLeft,
...
import { GenerationTaskError } from "~/routes/($lang).generation.demonstration/components/task-view/generation-task-error"
import { StarRating } from "~/routes/($lang).generation.demonstration/components/task-view/star-rating"
import {
  InPaintingDialog,
  InPaintingImageDialogFragment,
  InPaintingImageDialogTaskFragment,
} from "~/routes/($lang).generation.demonstration/components/submission-view/in-painting-dialog"
import { CopyButton } from "~/routes/($lang).generation.demonstration/components/copy-button"
import { AutoResizeTextarea } from "~/components/auto-resize-textarea"
import { graphql, type FragmentOf } from "gql.tada"
import { toDateTimeText } from "~/utils/to-date-time-text"
import { useTranslation } from "~/hooks/use-translation"
import { GenerationTaskPostConfirmDialog } from "~/routes/($lang).generation.demonstration/components/generation-task-post-confirm-dialog"
import { GenerationTaskDeleteMemoConfirmDialog } from "~/routes/($lang).generation.demonstration/components/generation-task-delete-memo-confirm-dialog"
