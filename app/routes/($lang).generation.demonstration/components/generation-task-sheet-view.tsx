...
import { useCachedImageGenerationTask } from "~/routes/($lang).generation.demonstration/hooks/use-cached-image-generation-task"
import { useGenerationContext } from "~/routes/($lang).generation.demonstration/hooks/use-generation-context"
import { createImageFileFromUrl } from "~/routes/($lang).generation.demonstration/utils/create-image-file-from-url"
import { downloadImageFile } from "~/routes/($lang).generation.demonstration/utils/download-image-file"
import {
  GenerationImageResultSheetContentFragment,
  GenerationImageResultSheetContentTaskFragment,
  GenerationTaskSheetViewContent,
} from "~/routes/($lang).generation.demonstration/components/generation-task-sheet-view-content"
import {
  InProgressGenerationImageResultFragment,
  InProgressGenerationImageResultTaskFragment,
  InProgressImageGenerationTaskResult,
} from "~/routes/($lang).generation.demonstration/components/in-progress-image-generation-task-result"
import type { GenerationParameters } from "~/routes/($lang).generation.demonstration/types/generation-parameters"
import {
  type GenerationSize,
  parseGenerationSize,
} from "~/routes/($lang).generation.demonstration/types/generation-size"
import { useMutation } from "@apollo/client/index"
import { useCallback, useEffect, useState } from "react"
import { toast } from "sonner"
import { type FragmentOf, graphql } from "gql.tada"
import { useCachedImageGenerationResult } from "~/routes/($lang).generation.demonstration/hooks/use-cached-image-generation-result"
